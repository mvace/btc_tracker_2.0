...
class TestRegisterUser:
    ...
    @pytest.mark.anyio
    async def test_register_user_with_extra_fields(self, client: AsyncClient):
        """
...
class TestLoginUser:
    @pytest.mark.anyio
    async def test_login_user_success(self, client: AsyncClient, created_user: dict):
        """
    ...
    @pytest.mark.anyio
    async def test_login_user_with_case_insensitive_email(
        self, client: AsyncClient, created_user: dict
    ):
        """
        ...
        login_data = {
            "username": created_user["email"].upper(),
            "password": created_user["password"],
        }
        response = await client.post("/auth/token", data=login_data)
    ...
    @pytest.mark.anyio
    async def test_login_user_with_leading_or_trailing_whitespace(
        self, client: AsyncClient, created_user: dict
    ):
        """
    ...
    @pytest.mark.anyio
    async def test_user_login_with_empty_credentials(self, client: AsyncClient):
        """
